...
class AddPostViewController: UIViewController {
  ...
  struct AddPostViewLocalizedStrings {
   static let addPostVCTitle = NSLocalizedString("ADD_POST_TITLE", comment: "less than 10 charaters")
  }
  ...
  override func viewDidLoad() {
    ...
    navigationItem.title = AddPostViewLocalizedStrings.addPostVCTitle
  }
